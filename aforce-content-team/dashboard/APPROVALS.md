...
*The human gate (`../workflows/approval-workflow.md`). Statuses: READY FOR REVIEW → (APPROVED / EDITED / REJECTED+reason) → READY TO FILM → READY TO EDIT → READY TO SCHEDULE. Decisions are recorded in `../data/ceo_decisions.csv` (`../workflows/executive-decision-loop.md`). Last updated: 2026-08-20 after CEO decisions D-0001–D-0005.*
...
SF-002 sodium · SF-003 fighter · SF-004 thirst lags · SF-006 soursop · SF-009 quiet hours · SF-010 sweat · SF-012 first action · SF-013 arenas · SF-016 non-negotiables · SF-017 heat rules · FD-001 4:58 · FD-002 the call · FD-010 why Pause
**Next:** Creative Director groups them into the filming batches (pre-dawn founder session · kitchen · 5 AM gym · street · studio) — see the filming list in `../reports/2026-08-31-run-week.md` §10. Move rows to READY TO FILM as shoots are scheduled.

## APPROVED — CEO D-0003 (UGC briefs, 2026-08-20) — casting blocked on names

UGC-001–010 briefs approved as written. Agent 19 cannot source without leadership's first contacts (real people only). NIL review still applies to UGC-005 before any agreement.

## APPROVED — CEO D-0001 (campaign package) · D-0004 (command-center merge — executes on GitHub)

## DEFERRED — CEO D-0005: campaign-line graduation → revisit 2026-10-02 post-mortem

## READY FOR REVIEW (Phase-2+ items; not yet decided individually)

| ID | Concept | Platform | Campaign | Status | Reviewer Notes |
|---|---|---|---|---|---|
| SF-001 | pH on the can | TikTok | — | READY FOR REVIEW | |
| SF-005 | Ritual travels: airport | Reels | launch | READY FOR REVIEW | |
| SF-007 | Seven demands | Reels | launch | READY FOR REVIEW | |
| SF-014 | Hotel room ritual | TikTok | launch | READY FOR REVIEW | |
...
*(Recommend batching these as "Week-2/launch batch" at the next /ceo-review once the launch date is confirmed.)*
