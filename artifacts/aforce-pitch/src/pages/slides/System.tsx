    ...
    <div className="w-screen h-screen overflow-hidden relative bg-bg text-text font-body">
      ...
      <div className="absolute top-[40vh] bottom-[17vh] left-[6vw] right-[6vw] grid grid-cols-3 gap-[1.6vw] z-10">
        ...
        <div className="relative rounded-2xl bg-gradient-to-b from-blue/[0.14] via-blue/[0.04] to-transparent border border-blue/30 p-[1.6vw] flex flex-col overflow-hidden">
          ...
          <div className="flex items-end justify-center gap-[0.6vw] h-[24vh] mb-[1.4vh]">
            <img src={`${base}can-berry.png`} alt="" className="h-[24vh] object-contain drop-shadow-2xl" />
            <img src={`${base}stick-berry.png`} alt="" className="h-[20vh] object-contain drop-shadow-2xl" />
          </div>
          <div className="font-body uppercase tracking-[0.28em] text-[0.7vw] text-blue font-semibold mb-[0.8vh]">Flavor 01</div>
          <div className="font-display text-[2vw] leading-[1] tracking-tight text-text mb-[0.4vh]">Berry Blast</div>
          <div className="font-body uppercase tracking-[0.22em] text-[0.85vw] text-blue mb-[1vh]">+ Dulse</div>
          <div className="font-body text-[0.85vw] text-text/65 leading-snug mb-auto">Antioxidants and trace minerals from a sea vegetable rich in iodine, iron, and potassium.</div>
          <div className="pt-[1.2vh] border-t border-blue/20 mt-[1.2vh]">
        ...
        <div className="relative rounded-2xl bg-gradient-to-b from-primary/[0.14] via-primary/[0.04] to-transparent border border-primary/30 p-[1.6vw] flex flex-col overflow-hidden">
          ...
          <div className="flex items-end justify-center gap-[0.6vw] h-[24vh] mb-[1.4vh]">
            <img src={`${base}can-watermelon.png`} alt="" className="h-[24vh] object-contain drop-shadow-2xl" />
            <img src={`${base}stick-watermelon.png`} alt="" className="h-[20vh] object-contain drop-shadow-2xl" />
          </div>
          <div className="font-body uppercase tracking-[0.28em] text-[0.7vw] text-primary font-semibold mb-[0.8vh]">Flavor 02</div>
          <div className="font-display text-[2vw] leading-[1] tracking-tight text-text mb-[0.4vh]">Watermelon Surge</div>
          <div className="font-body uppercase tracking-[0.22em] text-[0.85vw] text-primary mb-[1vh]">+ Chlorella</div>
          <div className="font-body text-[0.85vw] text-text/65 leading-snug mb-auto">Natural electrolytes and L-citrulline paired with a green-algae superfood for clean output.</div>
          <div className="pt-[1.2vh] border-t border-primary/20 mt-[1.2vh]">
            <div className="font-body text-[0.7vw] text-text/55 uppercase tracking-[0.2em]">325ml Can · 14g Stick</div>
          </div>
        </div>
        ...
        <div className="relative rounded-2xl bg-gradient-to-b from-accent/[0.16] via-accent/[0.05] to-transparent border border-accent/35 p-[1.6vw] flex flex-col overflow-hidden">
          ...
          <div className="flex items-end justify-center gap-[0.6vw] h-[24vh] mb-[1.4vh]">
            <img src={`${base}can-soursop.png`} alt="" className="h-[24vh] object-contain drop-shadow-2xl" />
            <img src={`${base}stick-soursop.png`} alt="" className="h-[20vh] object-contain drop-shadow-2xl" />
          </div>
          <div className="font-body uppercase tracking-[0.28em] text-[0.7vw] text-accent font-semibold mb-[0.8vh]">Flavor 03</div>
          <div className="font-display text-[2vw] leading-[1] tracking-tight text-text mb-[0.4vh]">Soursop Edge</div>
          <div className="font-body uppercase tracking-[0.22em] text-[0.85vw] text-accent mb-[1vh]">+ Sea Moss</div>
          <div className="font-body text-[0.85vw] text-text/65 leading-snug mb-auto">92 minerals from one ocean-grown botanical — iodine, magnesium, zinc, and selenium in a single plant.</div>
          <div className="pt-[1.2vh] border-t border-accent/20 mt-[1.2vh]">
            <div className="font-body text-[0.7vw] text-text/55 uppercase tracking-[0.2em]">325ml Can · 14g Stick</div>
          </div>
        </div>
      </div>
