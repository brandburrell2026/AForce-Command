    ...
    <SlideFrame slide={7}>
      <div className="absolute inset-0 overflow-hidden">
        ...
        <div className="absolute inset-y-0 right-0 z-10 flex w-[40%] flex-col items-center justify-center px-[3vw] text-center">
          ...
          <motion.div
            className="relative mt-[3.6vh] font-display uppercase tracking-[0.22em] text-[3.4vw] leading-[1.25] text-text font-bold drop-shadow-[0_0.4vw_1.4vw_rgba(228,30,43,0.12)]"
            initial={reduce ? false : { opacity: 0, y: 12 }}
            animate={{ opacity: 1, y: 0 }}
