export default function OSDashboards() {
  const clutchRoster = [
    { num: "07", name: "J. Grant",   pos: "PG",  tier: "PLATINUM", tierColor: "text-accent", tierBg: "bg-accent/15 border-accent/55", score: 96, hyd: 92, action: "Hold" },
    { num: "11", name: "K. Moss",    pos: "SG",  tier: "STABLE",   tierColor: "text-blue",   tierBg: "bg-blue/15 border-blue/55",     score: 81, hyd: 78, action: "Sip" },
    { num: "23", name: "D. Reyes",   pos: "SF",  tier: "RECOVERY", tierColor: "text-text",   tierBg: "bg-text/10 border-text/30",     score: 64, hyd: 61, action: "RTD" },
    { num: "04", name: "M. Park",    pos: "PF",  tier: "DEPLETED", tierColor: "text-primary",tierBg: "bg-primary/15 border-primary/55",score:42,hyd: 38, action: "Sub" },
    { num: "33", name: "T. Okafor",  pos: "C",   tier: "STABLE",   tierColor: "text-blue",   tierBg: "bg-blue/15 border-blue/55",     score: 77, hyd: 74, action: "Sip" },
    { num: "15", name: "R. Vance",   pos: "G",   tier: "PLATINUM", tierColor: "text-accent", tierBg: "bg-accent/15 border-accent/55", score: 91, hyd: 88, action: "Hold" },
  ];
  ...
  return (
    <div className="w-screen h-screen overflow-hidden relative bg-bg text-text font-body">
      ...
      <div className="absolute top-[5vh] left-[6vw] right-[6vw] flex justify-between items-center z-10">
        ...
        <div className="font-body uppercase tracking-[0.32em] text-[1.5vw] text-muted">15 / 26</div>
      </div>
      ...
      <div className="absolute top-[34vh] bottom-[14vh] left-[6vw] right-[6vw] grid grid-cols-2 gap-[2vw] z-10">
        ...
        >
          ...
          <div className="px-[1vw] pt-[0.7vh] flex-1 flex flex-col min-h-0">
            ...
            <div className="flex-1 overflow-hidden">
              {clutchRoster.map((r) => (
                <div
                  key={r.num}
                  className="grid grid-cols-[1.4vw_1fr_1.5vw_4.5vw_2.4vw_2.8vw] gap-[0.5vw] items-center py-[0.55vh] border-b border-text/5 font-body text-[0.7vw]"
                >
                  ...
                  <span className={`px-[0.4vw] py-[0.15vh] rounded-full border ${r.tierBg} ${r.tierColor} font-bold uppercase tracking-[0.14em] text-[0.5vw] text-center`}>{r.tier}</span>
                  <span className="text-text font-bold tabular-nums text-right">{r.score}</span>
                  <span className="text-right">
                    <span className="px-[0.45vw] py-[0.18vh] rounded border border-blue/55 bg-blue/15 text-blue font-bold uppercase tracking-[0.1em] text-[0.55vw]">{r.action}</span>
                  </span>
                </div>
              ))}
            </div>
          ...
          <div className="px-[1vw] py-[0.9vh] bg-blue/[0.08] border-t border-blue/25 flex items-center justify-between">
            <div className="flex items-center gap-[0.6vw]">
              ...
              <span className="font-body text-text/50 text-[0.6vw]">· auto-replenish queued × 4</span>
            </div>
        ...
        >
          ...
          <div className="px-[1vw] pt-[0.7vh] flex-1 flex flex-col min-h-0">
            ...
            <div className="pb-[0.8vh] border-b border-text/8">
              ...
              {/* Stacked bar */}
              <div className="flex h-[1vh] rounded-full overflow-hidden border border-text/10">
              ...
              <div className="flex items-center justify-between mt-[0.5vh] font-body text-[0.55vw]">
            ...
            {/* Critical alerts */}
            <div className="pt-[0.7vh] flex-1 flex flex-col min-h-0">
              <div className="flex items-center justify-between mb-[0.4vh]">
                <span className="font-body uppercase tracking-[0.16em] text-text/50 text-[0.55vw] font-semibold">Active Alerts · 3 escalated</span>
                <span className="font-body uppercase tracking-[0.18em] text-accent text-[0.55vw] font-bold">View all 12 →</span>
              </div>
              <div className="space-y-[0.5vh] flex-1 overflow-hidden">
                {guardianAlerts.map((a) => (
                  <div key={a.num} className="rounded-[0.4vw] border border-text/10 bg-white/[0.02] px-[0.6vw] py-[0.5vh] flex items-start gap-[0.6vw]">
                    <span className={`px-[0.4vw] py-[0.18vh] rounded border ${a.sevBg} ${a.sevColor} font-bold uppercase tracking-[0.14em] text-[0.5vw]`}>{a.sev}</span>
                    <div className="flex-1 min-w-0">
                      <div className="flex items-baseline justify-between gap-[0.5vw]">
                        <span className="font-body text-text text-[0.65vw] font-bold">#{a.num} · {a.who}</span>
                        <span className="font-body text-text/40 text-[0.5vw] tabular-nums">{a.time} ago</span>
                      </div>
                      <div className="font-body text-text/65 text-[0.6vw] leading-snug mt-[0.1vh]">{a.body}</div>
                    </div>
                  </div>
                ))}
              </div>
