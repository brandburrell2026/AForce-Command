...
// Front row: the three real cans — hero center, sharp, lit. Reflected on the floor.
const CANS = [
  { src: "can-watermelon-real", h: 56, left: 9, hero: false },
  { src: "can-berry-real", h: 64, left: 38, hero: true },
  { src: "can-soursop-real", h: 56, left: 70, hero: false },
];

export default function TheRitualReal() {
    ...
    <SlideFrame slide={10}>
      <div className="absolute inset-0 overflow-hidden">
        ...
        <div className="absolute right-0 bottom-0 top-0 w-[58%] z-0">
          ...
          {/* the real hero stick — floating softly above the lineup, clear of the cans */}
          <motion.img
            src={img("stick-soursop-real-pouch")}
            alt=""
