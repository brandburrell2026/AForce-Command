  ...
  return (
    <div className="w-screen h-screen overflow-hidden relative bg-bg text-text font-body">
      ...
      <div className="absolute top-[6vh] left-[6vw] right-[6vw] flex justify-between items-center z-10">
        ...
        <div className="font-body uppercase tracking-[0.32em] text-[1.5vw] text-muted">01 / 29</div>
      </div>

      <div className="absolute bottom-[8vh] left-[6vw] right-[55vw] z-10">
        ...
        <p className="mt-[3vh] font-display text-[2.4vw] leading-tight text-text max-w-[42vw] text-pretty">
          Drink <span className="text-primary">AForce</span>. Run on <span className="text-accent">AForce OS</span>.
        </p>
        <p className="mt-[1.5vh] font-body text-[1.6vw] font-light text-text/70 max-w-[42vw] text-pretty">
          Fuel your body with alkaline power.
        </p>
        <div className="mt-[4vh] font-body uppercase tracking-[0.32em] text-[1.5vw] text-muted">
