    ...
    <SlideChrome slide={1} eyebrow="01 · Executive Summary">
      <div className="absolute inset-0 grid grid-cols-12 px-[5vw] pt-[16vh] pb-[12vh] gap-x-[4vw]">
        <div className="col-span-7 flex flex-col h-full">
          ...
          <h1 className="font-display font-black tracking-[-0.035em] text-[7vw] leading-[0.92] text-text">
            A behavioral<br />
          ...
          <ul className="mt-auto pt-[4vh] space-y-[1.2vh] font-display text-[1.05vw] text-text/75 font-medium">
