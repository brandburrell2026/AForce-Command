...
export default function TheAdvisors() {
  ...
  const ADVISORS: Advisor[] = [
    ...
    },
    {
      ...
      title: "Founder & Investor · BrainTrust",
      area: "4× founder, 2 exits · $15M fund · Bestselling author",
      src: `${base}kendra.jpg`,
      position: "center 25%",
    },
    {
      name: "Jonathan Choa",
      title: "Strategic Finance & M&A · Keurig Dr Pepper",
      area: "$15B+ in transactions · West Point · Harvard MBA",
      src: `${base}jonathan.jpg`,
      position: "center 20%",
    },
    {
      name: "Mark Mendel",
  ...
  return (
    <SlideFrame slide={5}>
      <div className="absolute inset-0 flex flex-col justify-center px-[5vw] pt-[12vh] pb-[10vh]">
        ...
        {/* advisor cards */}
        <div className="mt-[4vh] grid grid-cols-6 gap-[1.2vw]">
          {ADVISORS.map((a, i) => (
            <motion.div
              key={a.name}
            ...
            >
              ...
              <div className="mt-[1.4vh] font-display text-[1.0vw] font-normal leading-[1.1] text-text">
                {a.name}
              </div>
              <div className="mt-[0.9vh] font-display text-[0.72vw] font-semibold leading-[1.35] text-red">
                {a.title}
              </div>
              <div className="mt-[0.9vh] font-body text-[0.72vw] leading-[1.5] text-text/55">
                {a.area}
              </div>
            </motion.div>
          ))}
