  ...
  return (
    <div className="w-screen h-screen overflow-hidden relative bg-bg text-text font-body">
      ...
      <div className="absolute top-[5vh] left-[6vw] right-[6vw] flex justify-between items-center z-10">
        <div className="font-body uppercase tracking-[0.32em] text-[1.5vw] text-accent font-semibold">10 — Product Tour</div>
        <div className="font-body uppercase tracking-[0.32em] text-[1.5vw] text-muted">10 / 25</div>
      </div>
      ...
      <div className="absolute top-[28vh] left-[6vw] right-[6vw] grid grid-cols-3 gap-[2vw] items-start z-10">
        ...
        <div className="flex flex-col items-center">
          ...
          <div className="mt-[1vh] text-center max-w-[24vw]">
        ...
        <div className="flex flex-col items-center">
          ...
          <div className="w-[16vw] h-[30vw] bg-bg-elev rounded-[2.2vw] border-2 border-text/20 overflow-hidden flex flex-col shadow-2xl ring-1" style={{ boxShadow: "0 0 60px rgba(157,124,251,0.15)" }}>
            ...
            {/* End the night */}
            <div className="mx-[0.7vw] mt-[0.5vh] rounded-[0.7vw] border py-[0.7vh] text-center font-body uppercase tracking-[0.22em] text-[0.5vw] font-bold" style={{ borderColor: "rgba(244,178,63,0.55)", color: "#F4B23F" }}>
              End the night
            </div>
      ...
      <div className="absolute bottom-[1.5vh] left-[6vw] right-[6vw] z-10">
