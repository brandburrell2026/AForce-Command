...
const STICKS = [
  { src: "stick-watermelon-s10", h: 48, left: 0 },
  { src: "stick-soursop-s10", h: 50, left: 30 },
  { src: "stick-berry-s10", h: 48, left: 62 },
];

// Front row: the three cans — hero center, sharp, lit. Reflected on the floor.
const CANS = [
  { src: "can-watermelon-s10", h: 56, left: 9, hero: false },
  { src: "can-berry-s10", h: 64, left: 38, hero: true },
  { src: "can-soursop-s10", h: 56, left: 70, hero: false },
];
