...
import { AFTopBar } from '@/components/ui';
...
export function SharePreviewScreenV2() {
  ...
  const SOCIAL_TARGETS: ReadonlyArray<{
    ...
    { id: 'sms',       label: 'Messages',  icon: 'message-square',   tint: af.textPrimary },
    { id: 'system',    label: 'More',      icon: 'more-horizontal',  tint: af.textPrimary },
  ];
...
const styles = StyleSheet.create({
  ...
  voiceLabelActive: { color: af.onRed },
  voiceTagline: {
    color: af.textTertiary,
    fontSize: 10,
    letterSpacing: 0.6,
  ...
  voiceTaglineActive: { color: af.onRed, opacity: 0.7 },
  ...
  formatBtnTextActive: { color: af.onRed },
  variantsCol: { gap: 8 },
  variantBtn: {
    flexDirection: 'row',
    alignItems: 'center',
  ...
  cta: {
    ...
    paddingVertical: 16,
    borderRadius: 14,
    backgroundColor: af.textPrimary,
  },
