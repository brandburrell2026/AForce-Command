...
const styles = StyleSheet.create({
  ...
  trayHeaderText: { fontSize: 10, fontFamily: 'Inter_700Bold', color: af.textTertiary, letterSpacing: 1.8 },
  ...
  chipText: { fontSize: 11, fontFamily: 'Inter_600SemiBold', color: af.textPrimary },
  qrChip: {
    flexDirection: 'row', alignItems: 'center', gap: 6,
    paddingHorizontal: 10, paddingVertical: 7,
  ...
  secondaryCtaText: { fontSize: 11, fontFamily: 'Inter_700Bold', color: af.textPrimary, letterSpacing: 1.2 },
  ...
  emptyTitle: { fontSize: 14, fontFamily: 'Inter_700Bold', color: af.textPrimary, marginTop: 4 },
  emptyHint: {
