...
function NativeSkinIACameraCapture({ onExit }: { onExit: () => void }) {
  ...
  if (state === 'QUALITY_INSUFFICIENT') return <QualityInsufficient onExit={onExit} onRetry={retryCapture} reason={qualityReason} />;
