 ...
 *
 * The `RefreshControl` sites in the app (Achievements + Leaderboard,
...
// Founder ruling 2026-08-27 (fifteen-twin retirement): the two legacy sites
// are deleted; the branding invariant continues on the two live V2 sites.
const SITES = [
...
describe('RefreshControl branding — all sites use af.* tokens for tintColor/colors/progressBackgroundColor', () => {
