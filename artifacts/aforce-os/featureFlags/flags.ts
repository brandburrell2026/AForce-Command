...
export const DEFAULT_FLAGS: FeatureFlags = {
  ...
  spec_sweat: false,
  spec_profile: false,
  spec_onboarding: false,
  spec_cart: false,
  spec_subscription: false,
  spec_manageSub: false,
  spec_leaderboard: false,
  spec_achievements: false,
  spec_notifScreen: false,
  spec_science: false,
  spec_legal: false,
  spec_sensors: false,
  spec_auth: false,
