  ...
  return (
    <div className="relative w-[390px] h-[844px] overflow-hidden bg-black text-white font-['Inter'] flex flex-col items-center">
      ...
      <div className="relative flex flex-col items-center justify-center mt-8">
        ...
        {/* Verdict */}
        <div className="mt-12 text-[11px] tracking-[0.5em] text-white/60 uppercase">
          P R O C E E D
        </div>
      </div>
      ...
      <div className="w-full px-8 mt-16 mb-auto flex flex-col">
        ...
        {/* Metric Row - SLEEP (Underperforming) */}
        <div className="flex items-center justify-between py-4 border-b border-white/[0.06]">
      ...
      <div className="pb-12 mt-auto">
        <button className="text-[11px] text-white/50 uppercase tracking-[0.1em] border-b border-white/20 pb-1 hover:text-white transition-colors duration-300">
          View 7-day window
        </button>
      </div>
    </div>
