    ...
    >
      <div ref={ref} className="mx-auto max-w-6xl">
        <div className="flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
          <div>
            <p className="eyebrow reveal text-signal">The Product</p>
            <h2 className="reveal mt-4 max-w-xl font-display text-3xl leading-tight tracking-[-0.01em] text-bone sm:text-4xl">
              Alkaline hydration, in silver.
            </h2>
          </div>
          <p className="reveal max-w-xs font-mono text-xs tracking-[0.16em] text-bone/45 uppercase">
            pH 8.8 · Electrolytes + Minerals
          </p>
        </div>
        ...
        <div className="mt-16 grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
          {FLAVORS.map((flavor, i) => (
            ...
            >
              {/* White product plate — studio can shot sits on white seamlessly */}
              ...
              <div className="px-1 pt-6">
                ...
                <p className="mt-2 font-mono text-xs tracking-[0.16em] text-bone/45 uppercase">
                  {flavor.botanical} · 11 fl oz
                </p>
                <p className="mt-3 text-sm leading-relaxed text-bone/55">
                  Alkaline hydration, electrolytes + minerals. pH 8.8.
                </p>
              </div>
            </article>
          ))}
