...
| **ER-5** | **In-app citation numbers** — `en.json:1794–1810` (Sawka 2007, Baker 2017, Cheuvront 2014, Maughan & Shirreffs 2010) | LIVE | Verification done (`CR-1-ER5-CITATION-VERIFICATION.md`): **1 SUPPORTED · 3 CHECK-PRIMARY · 2 MISMATCH**; arithmetic all PASS | performance-scientist (done) → citation fixes APPLIED | **VERIFIED + citation fixes APPLIED 2026-07-31** | MISMATCH copy defects fixed; then a primary-source check + performance-scientist pass **applied all 3 citation corrections** (Baker "Table 2"→"Figure 2" + range → 10–90 mmol/L; Maughan → 20(Suppl 2):59–69; §C/§G/§F → paper-level coords) across 11 locales + screen + comments. **`data/sweatSports.ts` reconciled 2026-07-31:** citation fixes APPLIED (value-preserving) — 8 sports were mis-cited to Baker 2017 (which has no per-sport means); now Barnes 2019 / Godek 2005 / Broad 1996 / Logan-Sprenger 2011 / range-anchors. Founder decisions recorded 2026-07-31: Hot Yoga **0.85→1.0 APPLIED** (Alrefai 2020); Basketball **kept 1.38** (declined Barnes 0.95). CrossFit locus resolved (Cronin 2016). **ER-5 fully closed** — every citation traced to a verified source. No claim risk |
