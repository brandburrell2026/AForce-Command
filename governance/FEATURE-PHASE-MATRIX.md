...
| 43 | AForce Moments — preparation layer (Moments, prep windows, ritual delivery) | LIVE in production (founder flip 2026-08-12): core + ritual + notifications + learning. Calendar core Built DARK — `moments_calendar_enabled` OFF pending Legal+Privacy (Appendix A) | Phase 2 | DR-010 ratified (+amended constraint 4); DR-011 5.3 signed; DR-012 Julius pending (+amended 3.1); **DR-013 ruled 2026-08-30** — Moments owns context/timing, RecoveryCommand owns the hydration action; a presented dose must mirror the canonical command exactly or be absent (§10 lifecycle NOT yet implemented). |
