...
| 43 | AForce Moments — preparation layer (Moments, prep windows, ritual delivery) | Phases 1–2 Built (flag `moments_enabled` OFF in prod); Phase 3a prep notifications In Build (flag `moments_notifications_enabled` OFF in prod) | Phase 2 (flag-gated) | Allocated by DR-010 (Brandon + Julius approved, fully ratified 2026-08-12). Calendar access NOT authorized (PR-002 5.2/5.3/5.5 open). |
